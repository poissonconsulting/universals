test_that("estimates.nlist::nlist", {
  ...
  expect_identical(
    estimates(nlist::nlist(z = 1:2), fun = median),
    nlist::nlist(z = 1:2)
  )
  expect_identical(
    estimates(nlist::nlist(z = 1:2), fun = function(x) 1L),
    nlist::nlist(z = c(1L, 1L))
  )
  expect_identical(
    estimates(
      nlist::nlist(z = 1:2),
...
test_that("estimates.nlist::nlists", {
  ...
  expect_identical(
    estimates(nlist::nlists(nlist::nlist(x = 1), nlist::nlist(x = 2))),
    nlist::nlist(x = 1.5)
  )
  expect_identical(
    estimates(nlist::nlists(
  ...
  expect_identical(
    estimates(
      nlist::nlists(nlist::nlist(x = 1), nlist::nlist(x = 2)),
      fun = function(x) x[1]
    ),
    nlist::nlist(x = 1)
  )
